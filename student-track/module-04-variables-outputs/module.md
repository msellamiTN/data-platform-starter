# M04 - Variables & Outputs

## Objectif
Variables valid̩es, outputs typ̩s et lifecycle.
...
4. Validez avec : powershell -ExecutionPolicy Bypass -File .\scripts\SelfPacedLab.ps1 -Module 4 -All

## Solution v̩rifi̩e
solutions/fil-rouge/01-day1-basics
