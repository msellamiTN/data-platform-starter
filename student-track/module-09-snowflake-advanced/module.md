# M09 - Snowflake Advanced

## Objectif
Ressources Snowflake avanc̩es (users, stages, file formats, etc.).
...
4. Validez avec : powershell -ExecutionPolicy Bypass -File .\scripts\SelfPacedLab.ps1 -Module 9 -All

## Solution v̩rifi̩e
solutions/fil-rouge/01-snowflake-learners et 05-capstone
