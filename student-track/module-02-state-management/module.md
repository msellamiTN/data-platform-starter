# M02 - State Management

## Objectif
Backend Azure Blob Storage et verrouillage par bail.
...
4. Validez avec : powershell -ExecutionPolicy Bypass -File .\scripts\SelfPacedLab.ps1 -Module 2 -All

## Solution v̩rifi̩e
solutions/fil-rouge/02-day1-state
