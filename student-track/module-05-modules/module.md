...
## Objectif
Extraire et r̩utiliser un module landing-zone.
...
4. Validez avec : powershell -ExecutionPolicy Bypass -File .\scripts\SelfPacedLab.ps1 -Module 5 -All

## Solution v̩rifi̩e
solutions/fil-rouge/03-day2-modules/modules/landing-zone
