# M03 - Import Brownfield

## Objectif
Importer une ressource existante et g̩rer la d̩rive.
...
4. Validez avec : powershell -ExecutionPolicy Bypass -File .\scripts\SelfPacedLab.ps1 -Module 3 -All

## Solution v̩rifi̩e
solutions/fil-rouge/03-day2-modules
