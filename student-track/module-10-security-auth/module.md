...
## Objectif
Authentification JWT RSA et Azure Key Vault.
...
4. Validez avec : powershell -ExecutionPolicy Bypass -File .\scripts\SelfPacedLab.ps1 -Module 10 -All

## Solution v̩rifi̩e
solutions/fil-rouge/03-day2-modules/modules/key-vault-rsa
